    ...
    public void next() {
        for (int row = 0; row < rows; row++) {
            for (int col = 0; col < columns; col++) {
                ...
                /*
                 * If neighboring cell count < 2, deactivate cell
                 * If neighboring cell count > 3, deactivate cell
                 * If neighboring cell count == 3, activate cell
                 * If neighbouring cell count == 2, continue
                 *
                 */
